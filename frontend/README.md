...
*(You should see a version number like `v18.x` or `v20.x`. If not, download it from [nodejs.org](https://nodejs.org/).)*
...
```bash
cd path/to/trademirror-frontend

```

### 2. Install dependencies

Download all required React and Tailwind packages (you only need to do this once):
...
Boot up Vite with the following command:
